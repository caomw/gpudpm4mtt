...
\documentclass[smallcondensed, final]{svjour3}[12/23/2011]
...
\begin{figure}
  \centering               
  \subfloat[]{\includegraphics[width=0.5\textwidth]{../img/synth1_bounce.pdf}}
  \subfloat[]{\includegraphics[width=0.5\textwidth]{../img/synth1_cross.pdf}}
