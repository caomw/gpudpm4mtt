...
%%%%%
% Need to include ratio of Dirichlet also in the above posterior predictive distro of a single observation
%%%%%
...
%%%%%
% define more rigorously, and then say why we don't include in experiments?
%%%%%
...
\begin{figure}[!]
  ...
  \caption{Performance metric comparison showing the (a) SFDA and (b) ATA results for submissions to the PETS2009/PETS2010 workshops shows comparable performance with state-of-the-art, object-specific detection and tracking strategies. Results for the technique in this paper are shown in red, and were computed using a covariance confidence interval threshold of 0.35.}
