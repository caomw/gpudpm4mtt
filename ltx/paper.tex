...
\begin{figure}
  \centering               
  \subfloat[]{\label{fig:ants_img}\includegraphics[width=0.5\textwidth]{antpic2.png}}
  \subfloat[]{\label{fig:ants_img_framediff}\includegraphics[width=0.5\textwidth]{frame_diff_ants_1.png}}
  \caption{(a.) Frame of a video containing five ants. (b.) Frame differencing extraction results from the same frame \willie{this is just a demo of the type of image i will have here... these aren't actually from the same frame, and also formatting is screwed up)}}
...
\begin{figure}
  \centering               
  \subfloat[]{\includegraphics[width=0.5\textwidth]{cross_final}}
  \subfloat[]{\includegraphics[width=0.5\textwidth]{bounce_final}}
...
\begin{figure}
  \centering               
  \subfloat[]{\includegraphics[width=0.35\textwidth, angle=30]{synth2_img}}
  \subfloat[]{\includegraphics[width=0.5\textwidth]{synth2_final}}
...
\begin{figure}
  \centering             
  \subfloat[]{\includegraphics[width=0.25\textwidth]{pets2001_1}}
  \subfloat[]{\includegraphics[width=0.25\textwidth]{pets2001_2}}
  \subfloat[]{\includegraphics[width=0.25\textwidth]{pets2001_3}}
  \subfloat[]{\includegraphics[width=0.25\textwidth]{pets2001_4}}
  \caption{Four frames $f=25, 35, 45, 55$ from the PETS2001 sequence with one posterior sample mean and covarance matrix overlayed. \willie{will show path trail over prev 10 frames}}
...
\begin{figure}
	\centering
	\subfloat[]{\includegraphics[width=0.52\textwidth]{pets2001_results_1}}
	\subfloat[]{\includegraphics[width=0.48\textwidth]{pets2001_results_2}}
...
\begin{figure}
  \centering             
  \subfloat[]{\includegraphics[width=0.25\textwidth]{pets2009_1}}
  \subfloat[]{\includegraphics[width=0.25\textwidth]{pets2009_2}}
  \subfloat[]{\includegraphics[width=0.25\textwidth]{pets2009_3}}
  \subfloat[]{\includegraphics[width=0.25\textwidth]{pets2009_4}}
  \caption{Four frames $f=10, 25, 35, 75$ from the PETS2009 sequence with one posterior sample mean and covarance matrix overlayed. \willie{will show path trail over prev 10 frames}}
...
\begin{figure}
	\centering
	\includegraphics[width=3in]{pets2009_results}
	% \subfloat[]{\includegraphics[width=0.52\textwidth]{pets2001_results_1}}
	% \subfloat[]{\includegraphics[width=0.48\textwidth]{pets2001_results_2}}
...
\begin{figure}
	\centering
	\subfloat[]{\includegraphics[width=0.5\textwidth]{pets2000_results_1}}
	\subfloat[]{\includegraphics[width=0.5\textwidth]{pets2000_results_2}}
	\caption{\willie{This dataset has not done that well so far. Not sure why. Here are two typical cases.}}
...
\begin{figure}
	\centering
	\includegraphics[width=3in]{pets2004_results_1}
	\caption{Sample from posterior of the mean for frames $f = 1-20$ overlayed on frame $f=20$.}
	\label{fig:pets2009_results}
\end{figure}
