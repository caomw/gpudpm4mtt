...
\bold{x}_{i} | c_{i}, \theta_{1:K_{t}, t} &\sim F(\theta_{c_{i}, t})
\end{split}
\end{align}
...
\begin{figure}[h]
        ...
        \caption{\label{fig:gpuddpm_gm_1} Graphical Model of the Generalized Polya Urn Dependent Dirichlet Process Mixture. Note that all observations at time $t$, $\bold{x}_{1:N,t}$, and their associated assignments $c_{1:N,t}$ are denoted respectively as $x_{t}$ and $c_{t}$ (this also holds for time step $t-1$).}
\end{figure}
% \begin{align}
% \begin{split}
