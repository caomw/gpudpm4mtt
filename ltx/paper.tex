...
\begin{figure}[h]
        ...
        \caption{\label{fig:alpha_overlay_1} Extracted data and sample from posterior of the model overlaid on three frames from the pets2001 video.}
\end{figure}
...
\begin{figure}
	\centering
	\subfloat[]{\includegraphics[width=0.6\textwidth]{../img/pets2000_results_1}}
	\subfloat[]{\includegraphics[width=0.40\textwidth]{../img/pets2000_4objects.png}}
	\caption{Extracted data and sample (a.) from posterior of the model overlaid (b.) on a frame from the pets2000 video}
