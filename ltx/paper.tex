...
\begin{figure}
  ...
  \caption{The SFDA (blue solid line) and ATA (red dashed line are) vs  confidence values from which an object's oval region is computed for (a.) PETS2000 and (b.) PETS2001 }
  \label{fig:pm_conf}
\end{figure}
