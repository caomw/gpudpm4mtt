...
%%%%%
% need to include the "standard MH acceptance ratio"
%%%%%
...
\begin{figure*}[!]
  \centering             
  \subfloat[]{\includegraphics[width=0.48\textwidth]{../img/pets2009full_sens_sfda_heat.pdf}}
  \hspace{6mm}
  \subfloat[]{\includegraphics[width=0.48\textwidth]{../img/pets2009full_sens_ata_heat.pdf}}
