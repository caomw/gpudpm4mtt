...
% serves to introduce a new technique involving the use of dependent Dirichlet process mixture models, which we hope will provide the foundation for a class of unsupervised algorithms that can detect and track arbitrary objects in a wide range of videos.
